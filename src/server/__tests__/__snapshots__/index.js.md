...
> Snapshot 1
    ...
    '<x-example class="resolved"><section><div>Hello Adam!</div><style type="text/css">@import "https://www.example.org/atimberlake/Webroot/Switzerland/src/server/__tests__/styles/index.css";</style></section></x-example>'
