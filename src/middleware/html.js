...
export default html => {
    ...
    return props => {
        ...
        const boundary = props.universal ? null : props.node.shadowRoot;
        ...
        props.attached && !props.universal && !props.node.firstChild && boundary.insertBefore(root, boundary.firstChild);
